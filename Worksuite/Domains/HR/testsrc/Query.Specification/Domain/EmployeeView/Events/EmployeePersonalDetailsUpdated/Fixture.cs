...
{
    public class EmployeePersonalDetailsUpdatedFixture
    {
        ...
        public EmployeePersonalDetailsUpdatedFixture()
        {
            employee_view_repository = DependencyResolver.resolve<IEntityRepository<Query.EmployeeView>>();
            event_handler = DependencyResolver.resolve<UpdateEmployeeViewWhenPersonalDetailsUpdated>();
        ...
        public IEventSubscriber<EmployeePersonalDetailsUpdatedEvent> event_handler { get; private set; }
