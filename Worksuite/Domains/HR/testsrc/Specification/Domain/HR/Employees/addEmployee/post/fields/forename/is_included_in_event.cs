...
{
    [TestClass]
    public class EmployeeForename_is_included_in_event : CommandPublishedEventSpecification<HRTestBootstrap, AddEmployeeRequestHandler_fixture>
    {
        public EmployeeForename_is_included_in_event()
            : base(
                arrange: fixture => { },
                ...
                .Match(
                    ...
                    has_value:
                        created_event => Assert.IsTrue(created_event.forename == fixture.entity.forename),
