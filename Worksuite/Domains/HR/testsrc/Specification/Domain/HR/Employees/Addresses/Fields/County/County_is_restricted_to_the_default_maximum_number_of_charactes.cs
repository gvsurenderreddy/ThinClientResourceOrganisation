...
namespace WTS.WorkSuite.HR.Services.Domain.HR.Employees.Addresses.Fields.County {

    public class County_is_restricted_to_the_default_maximum_number_of_charactes {
        ...
        public class verify_on_create
            ...
            public verify_on_create()
                    : base( (request, value) => request.county = value) { }
        }
