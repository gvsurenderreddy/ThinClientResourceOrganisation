...
{
    [TestClass]
    public class Correctly_maps_is_hidden_for_a_maritalStatus
                    :   Correctly_maps_is_hidden< MaritalStatus, MaritalStatusBuilder, MaritalStatusDetails, GetDetailsOfASpecificMaritalStatusFixture > {}
}
