...
{
    [TestClass]
    public class Is_Hidden_for_a_Title_defaults_to_false_for_a_marital_status
        :   Is_Hidden_defaults_to_false< CreateMaritalStatusRequest, GetCreateMaritalStatusRequestResponse, IGetCreateMaritalStatusRequest > {}
}
