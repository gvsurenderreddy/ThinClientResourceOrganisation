...
{
    [TestClass]
    public class Returns_the_correct_nationality
                        : Returns_the_correct_entity< Nationality, NationalityBuilder, NationalityDetails, GetDetailsOfASpecificNationalityFixture > {}
}