...
{
    public class A_description_for_a_Relationship_is_mandatory_on_create 
        : A_description_is_mandatory_on_create<Relationship, CreateRelationshipRequest, CreateRelationshipResponse, ICreateRelationship, NewRelationshipFixture> { }
}