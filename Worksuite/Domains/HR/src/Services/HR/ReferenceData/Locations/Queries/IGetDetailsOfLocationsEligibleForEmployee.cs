...
{
    /// <summary>
    ///     Get all the locations that are eligible for the specified employee, the criteria is:
    ...
    /// </remarks>
    public interface IGetDetailsOfLocationsEligibleForEmployee
                        : IGetDetailsOfReferencDataEligibleForEmployee<LocationDetails> { }
}