...
{
    /// <summary>
    ///     Response object returned by the <see cref="IGetUpdateLocationRequest"/>.  This is our
    /// standard response object with the UpdateRequest as it's response property.
    /// </summary>
    public class GetUpdateLocationRequestResponse
                    : GetUpdateReferenceDataRequestResponse<UpdateLocationRequest> { }
}