...
namespace WTS.WorkSuite.HR.HR.ReferenceData.Genders.Edit.GetUpdateRequest {
    ...
    /// <summary>
    ///     Response object returned by the <see cref="IGetUpdateGenderRequest"/>.  This is our
    /// standard response object with the UpdateRequest as it's response property.
    /// </summary>
    public class GetUpdateGenderRequestResponse 
                    : GetUpdateReferenceDataRequestResponse<UpdateGenderRequest> {}                    
