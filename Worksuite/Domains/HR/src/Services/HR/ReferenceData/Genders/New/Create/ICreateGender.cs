...
namespace WTS.WorkSuite.HR.HR.ReferenceData.Genders.New.Create {
    ...
    /// </summary>
    public interface ICreateGender 
                        : ICreateReferenceData<CreateGenderRequest, CreateGenderResponse> {}
