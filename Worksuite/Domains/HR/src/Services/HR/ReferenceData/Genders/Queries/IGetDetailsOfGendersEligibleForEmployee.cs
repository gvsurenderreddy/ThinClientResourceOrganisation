...
namespace WTS.WorkSuite.HR.HR.ReferenceData.Genders.Queries {
    ...
    /// <summary>
    ///     Get all the genders that are eligible for the specified employee, the criteria is:
    ...
    /// </remarks>
    public interface IGetDetailsOfGendersEligibleForEmployee
                            : IGetDetailsOfReferencDataEligibleForEmployee<GenderDetails> {}
