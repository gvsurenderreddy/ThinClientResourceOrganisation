...
namespace WTS.WorkSuite.HR.HR.ReferenceData.MaritalStatuses.Queries {
    ...
    /// <summary>
    ///     Get all the MaritalStatuses that are eligible for the specified employee, the criteria is:
    ...
    /// </remarks>
    public interface IGetDetailsOfMaritalStatusesEligibleForEmployee
                            : IGetDetailsOfReferencDataEligibleForEmployee<MaritalStatusDetails> {}
