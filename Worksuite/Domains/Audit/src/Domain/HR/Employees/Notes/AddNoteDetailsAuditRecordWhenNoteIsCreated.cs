...
{
    public class AddNoteDetailsAuditRecordWhenNoteIsCreated
                        : IEventSubscriber<EmployeeNoteCreatedEvent>
    {
        public void handle(EmployeeNoteCreatedEvent the_event_to_handle)
        {
            this
        ...
        private AddNoteDetailsAuditRecordWhenNoteIsCreated set_event(EmployeeNoteCreatedEvent the_event_to_handle)
        {
        ...
        private AddNoteDetailsAuditRecordWhenNoteIsCreated get_employee_audit_trail()
        {
        ...
        private AddNoteDetailsAuditRecordWhenNoteIsCreated add_employee_audit_record()
        {
        ...
        private AddNoteDetailsAuditRecordWhenNoteIsCreated add_note_details_created_audit_record()
        {
        ...
        public AddNoteDetailsAuditRecordWhenNoteIsCreated(GetOrCreateEmployeeAuditTrail<EmployeeNoteCreatedEvent> the_get_or_created_employee_audit_trail,
                                                        EmployeeNoteDetailsAuditRecordBuilder<EmployeeNoteCreatedEvent> the_note_details_audit_record_builder,
                                                        EmployeeAuditRecordBuilder<EmployeeNoteCreatedEvent> the_employee_audit_record_builder,
                                                        Clock the_clock,
        ...
        private readonly GetOrCreateEmployeeAuditTrail<EmployeeNoteCreatedEvent>
            _get_or_created_employee_audit_trail;

        private readonly EmployeeNoteDetailsAuditRecordBuilder<EmployeeNoteCreatedEvent>
            _note_details_audit_record_builder;

        private readonly EmployeeAuditRecordBuilder<EmployeeNoteCreatedEvent> _employee_audit_record_builder;
        private readonly Clock _clock;
        private readonly IUnitOfWork _unit_of_work;

        private EmployeeNoteCreatedEvent _event_to_handle;
