...
namespace WTS.WorkSuite.Audit.Domain.HR.Employees.PersonalDetails.Fields.place_of_birth
{
    public class PlaceOfBirth_is_audited_in_the_personal_details_audit_record
    {
        [TestClass]
        ...
        {
            [TestMethod]
            public void a_null_place_of_birth_is_written_to_the_employee_personal_details_audit_record()
            {
                ...
                fixture
                    ...
                    .Match(
                        has_value:
                            audit_record => audit_record.place_of_birth.Should().BeNull(),
        ...
        {
            [TestMethod]
            public void the_place_of_birth_is_written_to_the_employee_personal_details_audit_record()
            {
                ...
                fixture
                    ...
                    .Match(
                        has_value:
                            audit_record => audit_record.place_of_birth.Should().Be(update_event.place_of_birth),
