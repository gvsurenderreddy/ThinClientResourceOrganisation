...
{
    public class EmployeeAddressDetailsCreatedEventFixture
    {
        public EmployeeAddressDetailsCreatedEvent create_event()
        {
            ...
            return new EmployeeAddressDetailsCreatedEvent
                            {
                                employee_id = audit_trail.employee_id,
                                address_id = (new Random()).Next(),
                                number_or_name = "208",
                                line_one = "Middleton Road",
                                line_two = "a suburb",
        ...
        public AddAddressDetailsAuditRecordWhenAddressIsCreated event_handler { get; private set; }

        public FakeClock clock { get; private set; }

        public EmployeeAddressDetailsCreatedEventFixture()
        {
            event_handler = DependencyResolver.resolve<AddAddressDetailsAuditRecordWhenAddressIsCreated>();
