...
namespace WTS.WorkSuite.Audit.Domain.HR.Employees.AddressDetails.Fields.country
{
    public class Country_is_audited_in_the_address_details_audit_record
    {
        [TestClass]
        ...
        {
            [TestMethod]
            public void should_write_country_with_the_input_value_to_the_employee_address_details_audit_record()
            {
                ...
                fixture
                    ...
                    .Match(
                        ...
                        has_value:
                            audit_record => audit_record.country.Should().Be(create_event.country),
        ...
        {
            [TestMethod]
            public void should_write_country_with_the_updated_value_to_the_employee_address_details_audit_record()
            {
                ...
                fixture
                    ...
                    .Match(
                        ...
                        has_value:
                            audit_record => audit_record.country.Should().Be(update_event.country),
        ...
        {
            [TestMethod]
            public void should_write_country_with_the_value_when_the_address_was_removed_to_the_employee_address_details_audit_record()
            {
                ...
                fixture
                    ...
                    .Match(
                        ...
                        has_value:
                            audit_record => audit_record.country.Should().Be(remove_event.country),
