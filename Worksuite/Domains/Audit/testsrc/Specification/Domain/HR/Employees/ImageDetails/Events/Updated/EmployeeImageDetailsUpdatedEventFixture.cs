...
{
    public class EmployeeImageDetailsUpdatedEventFixture
    {
        public EmployeeImageDetailsUpdatedEvent create_event()
        {
            ...
            return new EmployeeImageDetailsUpdatedEvent
            {
        ...
        public AddImageDetailsAuditRecordWhenImageIsUpdated event_handler { get; private set; }

        public FakeClock clock { get; private set; }

        public EmployeeImageDetailsUpdatedEventFixture()
        {
            event_handler = DependencyResolver.resolve<AddImageDetailsAuditRecordWhenImageIsUpdated>();
