...
{
    [TestClass]
    public class Removing_an_employee_document_details
                        : EmployeeDocumentDetailsRemovedEventSpecification
    {
                    ...
                    has_value:
                        audit_trail =>
                        {
                            ...
                            audit_trail.document_details_audit.Should()
                                .Contain(ad => ad.triggered_by_event == typeof(EmployeeDocumentRemovedEvent).Name &&
        ...
        [TestMethod]
        public void should_add_an_employee_document_details_removed_audit_record_to_the_employee_audit_trail()
        {
            var remove_event = fixture.create_event();
            ...
            fixture
                ...
                .Match(
                    ...
                    has_value:
                        audit_record =>
                        {
                            audit_record.triggered_by_event.Should().Be(typeof(EmployeeDocumentRemovedEvent).Name);
