...
{
    [TestClass]
    public class Adds_an_employee_document
                        : EmployeeDocumentDetailsUploadedEventSpecification
    {
        [TestMethod]
        public void should_add_an_employee_document_details_audit_record_to_the_employee_audit_trail()
        {
            ...
            fixture
                ...
                .Match(
                    ...
                    has_value:
                        audit_trail =>
                        {
                            audit_trail.document_details_audit.Count.Should().Be(1);
                            audit_trail.document_details_audit.Should()
                                .Contain(
                                    ad => ad.triggered_by_event == typeof(EmployeeDocumentUploadedEvent).Name &&
        ...
        [TestMethod]
        public void should_add_an_employee_document_details_uploaded_audit_record_to_the_employee_audit_trail()
        {
            var create_event = fixture.create_event();
            ...
            fixture
                .get_last_document_details_audit_record_for(create_event)
                .Match(

                    has_value:
                        audit_record =>
                        {
                            audit_record.triggered_by_event.Should().Be(typeof(EmployeeDocumentUploadedEvent).Name);
