...
{
    public class EmployeeSkillDetailsRemovedEventFixture
    {
        public EmployeeSkillRemovedEvent create_event()
        {
            ...
            return new EmployeeSkillRemovedEvent
            {
                employee_id = audit_trail.employee_id,
                employee_skill_id = (new Random()).Next(),
                employee_skill_description = "A skill",
                priority = 3
            };
        }

        public Maybe<EmployeeSkillDetailsAuditRecord> get_last_employee_skill_details_audit_record_for(EmployeeSkillIdentity the_skill)
        {
            return this
        ...
        public AddSkillDetailsAuditRecordWhenAnEmployeeSkillIsRemoved event_handler { get; private set; }

        public FakeClock clock { get; private set; }

        public EmployeeSkillDetailsRemovedEventFixture()
        {
            event_handler = DependencyResolver.resolve<AddSkillDetailsAuditRecordWhenAnEmployeeSkillIsRemoved>();
