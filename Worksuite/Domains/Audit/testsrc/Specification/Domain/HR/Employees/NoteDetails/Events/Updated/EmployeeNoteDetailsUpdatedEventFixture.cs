...
{
    public class EmployeeNoteDetailsUpdatedEventFixture
    {
        public EmployeeNoteUpdatedEvent create_event()
        {
            ...
            return new EmployeeNoteUpdatedEvent
            {
        ...
        public AddNoteDetailsAuditRecordWhenNoteIsUpdated event_handler { get; private set; }

        public FakeClock clock { get; private set; }

        public EmployeeNoteDetailsUpdatedEventFixture()
        {
            event_handler = DependencyResolver.resolve<AddNoteDetailsAuditRecordWhenNoteIsUpdated>();
