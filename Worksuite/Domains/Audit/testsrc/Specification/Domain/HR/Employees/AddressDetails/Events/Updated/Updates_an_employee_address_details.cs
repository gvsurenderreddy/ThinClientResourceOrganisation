...
{
    [TestClass]
    public class Updates_an_employee_address_details
                        : EmployeeAddressDetailsUpdatedEventSpecification
    {
                    ...
                    has_value:
                        audit_trail =>
                        {
                            ...
                            audit_trail.address_details_audit.Should()
                                .Contain(ad => ad.triggered_by_event == typeof(EmployeeAddressDetailsUpdatedEvent).Name &&
        ...
        [TestMethod]
        public void should_add_an_employee_address_details_updated_audit_record_to_the_employee_audit_trail()
        {
            var update_event = fixture.create_event();
            ...
            fixture
                ...
                .Match(
                    ...
                    has_value:
                        audit_record =>
                        {
                            audit_record.triggered_by_event.Should().Be(typeof(EmployeeAddressDetailsUpdatedEvent).Name);
