...
{
    [TestClass]
    public class Removing_an_employee_note_details
                        : EmployeeNoteDetailsRemovedEventSpecification
    {
                    ...
                    has_value:
                        audit_trail =>
                        {
                            ...
                            audit_trail.note_details_audit.Should()
                                .Contain(ad => ad.triggered_by_event == typeof(EmployeeNoteRemovedEvent).Name &&
        ...
        [TestMethod]
        public void should_add_an_employee_note_details_removed_audit_record_to_the_employee_audit_trail()
        {
            var remove_event = fixture.create_event();
            ...
            fixture
                ...
                .Match(
                    ...
                    has_value:
                        audit_record =>
                        {
                            audit_record.triggered_by_event.Should().Be(typeof(EmployeeNoteRemovedEvent).Name);
