...
namespace WTS.WorkSuite.Audit.Domain.HR.Employees.DocumentDetails.Fields.description
{
    public class Description_is_audited_in_the_document_details_audit_record
    {
        [TestClass]
        ...
        {
            [TestMethod]
            public void should_write_description_with_the_input_value_to_the_employee_document_details_audit_record()
            {
                ...
                fixture
                    ...
                    .Match(
                        ...
                        has_value:
                            audit_record => audit_record.description.Should().Be(upload_event.description),
        ...
        {
            [TestMethod]
            public void should_write_description_with_the_value_when_the_document_was_removed_to_the_employee_document_details_audit_record()
            {
                ...
                fixture
                    ...
                    .Match(
                        ...
                        has_value:
                            audit_record => audit_record.description.Should().Be(remove_event.description),
