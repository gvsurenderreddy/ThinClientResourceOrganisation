...
namespace WTS.WorkSuite.Audit.Domain.HR.Employees.AddressDetails.Fields.house_name_or_number
{
    public class HouseNameOrNumber_is_audited_in_the_address_details_audit_record
    {
        [TestClass]
        ...
        {
            [TestMethod]
            public void should_write_house_name_or_number_with_the_input_value_to_the_employee_address_details_audit_record()
            {
                ...
                fixture
                    ...
                    .Match(
                        ...
                        has_value:
                            audit_record => audit_record.number_or_name.Should().Be(create_event.number_or_name),
        ...
        {
            [TestMethod]
            public void should_write_house_name_or_number_with_the_updated_value_to_the_employee_address_details_audit_record()
            {
                ...
                fixture
                    ...
                    .Match(
                        ...
                        has_value:
                            audit_record => audit_record.number_or_name.Should().Be(update_event.number_or_name),
        ...
        {
            [TestMethod]
            public void should_write_house_name_or_number_with_the_value_when_the_address_was_removed_to_the_employee_address_details_audit_record()
            {
                ...
                fixture
                    ...
                    .Match(
                        ...
                        has_value:
                            audit_record => audit_record.number_or_name.Should().Be(remove_event.number_or_name),
