...
namespace WTS.WorkSuite.Audit.Domain.HR.Employees.AddressDetails.Fields.county
{
    public class County_is_audited_in_the_address_details_audit_record
    {
        [TestClass]
        ...
        {
            [TestMethod]
            public void should_write_county_with_the_input_value_to_the_employee_address_details_audit_record()
            {
                ...
                fixture
                    ...
                    .Match(
                        ...
                        has_value:
                            audit_record => audit_record.county.Should().Be(create_event.county),
        ...
        {
            [TestMethod]
            public void should_write_county_with_the_updated_value_to_the_employee_address_details_audit_record()
            {
                ...
                fixture
                    ...
                    .Match(
                        ...
                        has_value:
                            audit_record => audit_record.county.Should().Be(update_event.county),
        ...
        {
            [TestMethod]
            public void should_write_county_with_the_value_when_the_address_was_removed_to_the_employee_address_details_audit_record()
            {
                ...
                fixture
                    ...
                    .Match(
                        ...
                        has_value:
                            audit_record => audit_record.county.Should().Be(remove_event.county),
