...
{
    public class NotesListPresenter : Presenter
    {
        ...
        public NotesListPresenter(IGetAllNotes get_all_query
            , DetailsListBuilder<EmployeeNoteDetails> the_list_builder)
        {
        ...
        private readonly DetailsListBuilder<EmployeeNoteDetails> list_builder;
    }
}