...
namespace WTS.WorkSuite.Web.ThinClient.Application.HR.ReferenceData.Genders.Presentation.New
{
    public class MetadataConfiguration
                    : EditorMetadataBuilder<CreateGenderRequest>
    {
        protected override void build_model_metadata
                                    (IEditorModelMetadataBuilder<CreateGenderRequest> metadata_builder)
        {
            metadata_builder
        ...
        protected override void build_field_metadata
                                    (IEditorFieldsMetadataBuilder<CreateGenderRequest> metadata_builder)
        {
            metadata_builder
        ...
        protected override void build_action_metadata
                                    (IEditorActionsMetadataBuilder<CreateGenderRequest> metadata_builder)
        {
