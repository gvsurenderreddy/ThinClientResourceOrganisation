...
namespace WTS.WorkSuite.Web.ThinClient.Application.HR.ReferenceData.Skills.Presentation.Report
{
    public class MetadataConfiguration 
                            :   ReportMetadataBuilder< SkillDetails >
    {
        protected override void build_model_metadata( IReportModelMetadataBuilder< SkillDetails > model_metadata_builder )
        {
        ...
        protected override void build_field_metadata( IReportFieldsMetadataBuilder< SkillDetails > field_metadata_builder )
        {
        ...
        protected override void build_action_metadata( IReportActionsMetadataBuilder< SkillDetails > action_metadata_builder)
        {
