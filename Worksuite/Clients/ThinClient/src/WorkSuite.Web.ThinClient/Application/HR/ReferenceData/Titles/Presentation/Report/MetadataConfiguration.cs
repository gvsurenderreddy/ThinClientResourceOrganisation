...
namespace WTS.WorkSuite.Web.ThinClient.Application.HR.ReferenceData.Titles.Presentation.Report
{
    public class MetadataConfiguration : ReportMetadataBuilder<TitleDetails>
    {
        protected override void build_model_metadata(IReportModelMetadataBuilder<TitleDetails> model_metadata_builder)
        {
        ...
        protected override void build_field_metadata(IReportFieldsMetadataBuilder<TitleDetails> field_metadata_builder)
        {
        ...
        protected override void build_action_metadata(IReportActionsMetadataBuilder<TitleDetails> action_metadata_builder)
        {
