...
namespace WTS.WorkSuite.Web.ThinClient.Application.HR.ReferenceData.MaritalStatuses.Presentation.Editor
{
    public class MetadataConfiguration
                            : EditorMetadataBuilder<UpdateMaritalStatusRequest>
    {
        protected override void build_model_metadata(IEditorModelMetadataBuilder<UpdateMaritalStatusRequest> model_metadata_builder)
        {
        ...
        protected override void build_field_metadata(IEditorFieldsMetadataBuilder<UpdateMaritalStatusRequest> fields_metadata_builder)
        {
        ...
        protected override void build_action_metadata(IEditorActionsMetadataBuilder<UpdateMaritalStatusRequest> actions_metadata_builder)
        {
