...
namespace WTS.WorkSuite.Web.ThinClient.Application.HR.ReferenceData.Relationships.Presentation.Report
{
    public class MetadataConfiguration
                    : ReportMetadataBuilder<RelationshipDetails>
    {

        protected override void build_model_metadata
                                    (IReportModelMetadataBuilder<RelationshipDetails> model_metadata_builder)
        {
        ...
        protected override void build_field_metadata
                                    (IReportFieldsMetadataBuilder<RelationshipDetails> field_metadata_builder)
        {
        ...
        protected override void build_action_metadata
                                    (IReportActionsMetadataBuilder<RelationshipDetails> action_metadata_builder)
        {
