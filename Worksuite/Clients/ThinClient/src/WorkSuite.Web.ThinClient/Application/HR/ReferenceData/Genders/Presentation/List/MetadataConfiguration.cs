...
namespace WTS.WorkSuite.Web.ThinClient.Application.HR.ReferenceData.Genders.Presentation.List {
    ...
    public class MetadataConfiguration 
                    : global::WorkSuite.Library.Asp.Net.Mvc.Server.Framework.ViewModels.DetailsLists.Metadata.Static.DetailsListMetadataBuilder<GenderDetails> {

        protected override void build_list_metadata
                                    ( IDetailsListMetadataBuilder<GenderDetails> builder ) {
        ...
        protected override void build_list_actions_metadata
                                    ( IDetailsListActionsMetadataBuilder<GenderDetails> builder ) {
            
            builder
                .add_action<DetailsList.New>(  )
                .id( Genders.Presentation.New.Resources.id )
                ;
