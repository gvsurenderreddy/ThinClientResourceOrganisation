...
namespace WTS.WorkSuite.Web.ThinClient.Application.HR.ReferenceData.Nationalities.Presentation.New
{
    public class MetadataConfiguration
                        : EditorMetadataBuilder<CreateNationalityRequest>
    {
        protected override void build_model_metadata(IEditorModelMetadataBuilder<CreateNationalityRequest> model_metadata_builder)
        {
            model_metadata_builder
                .id("new-nationality-request")
                .title(Resources.title)
                ;
        }

        protected override void build_field_metadata(IEditorFieldsMetadataBuilder<CreateNationalityRequest> fields_metadata_builder)
        {
        ...
        protected override void build_action_metadata(IEditorActionsMetadataBuilder<CreateNationalityRequest> actions_metadata_builder)
        {
