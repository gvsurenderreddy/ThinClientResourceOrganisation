...
namespace WTS.WorkSuite.Web.ThinClient.Application.HR.ReferenceData.Genders.Presentation.Page {
    

    public class ConfigureGendersPresenter
                    : Presenter {
        ...
        public ActionResult Page () {
            ...
            return View( @"~\Views\HR\ReferenceData\Genders\Page.cshtml", view_model );
        }


        public ConfigureGendersPresenter
