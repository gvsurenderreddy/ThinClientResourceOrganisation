...
namespace WTS.WorkSuite.Web.ThinClient.Application.HR.ReferenceData.EthnicOrigins.Presentation.Page
{
    public class ConfigureEthnicOriginsPresenter
                        : Presenter
    {
        public ActionResult Page()
        {
            ...
            return View( @"~\Views\HR\ReferenceData\EthnicOriginals\Page.cshtml", view_model );
        }

        public ConfigureEthnicOriginsPresenter(   IGetDetailsOfAllEthnicOrigins get_details_of_all_ethnic_originals,
