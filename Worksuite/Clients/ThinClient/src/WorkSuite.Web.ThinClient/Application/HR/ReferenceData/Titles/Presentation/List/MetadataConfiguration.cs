...
namespace WTS.WorkSuite.Web.ThinClient.Application.HR.ReferenceData.Titles.Presentation.List {
    ...
    public class MetadataConfiguration : global::WorkSuite.Library.Asp.Net.Mvc.Server.Framework.ViewModels.DetailsLists.Metadata.Static.DetailsListMetadataBuilder<TitleDetails> {

        protected override void build_list_metadata ( IDetailsListMetadataBuilder<TitleDetails> builder ) {
        ...
        protected override void build_list_actions_metadata ( IDetailsListActionsMetadataBuilder<TitleDetails> builder ) {
