...
namespace WTS.WorkSuite.Web.ThinClient.Application.HR.ReferenceData.Skills.Presentation.New
{
    public class MetadataConfiguration
                        : EditorMetadataBuilder<CreateSkillRequest>
    {
        protected override void build_model_metadata(IEditorModelMetadataBuilder<CreateSkillRequest> model_metadata_builder)
        {
            model_metadata_builder
                .id("new-skill-request")
                .title(Resources.title)
                ;
        }

        protected override void build_field_metadata(IEditorFieldsMetadataBuilder<CreateSkillRequest> fields_metadata_builder)
        {
        ...
        protected override void build_action_metadata(IEditorActionsMetadataBuilder<CreateSkillRequest> actions_metadata_builder)
        {
