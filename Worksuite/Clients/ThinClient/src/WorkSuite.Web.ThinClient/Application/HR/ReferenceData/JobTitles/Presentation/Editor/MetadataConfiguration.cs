...
namespace WTS.WorkSuite.Web.ThinClient.Application.HR.ReferenceData.JobTitles.Presentation.Editor
{
    public class MetadataConfiguration
                    : EditorMetadataBuilder<UpdateJobTitleRequest>
    {
        protected override void build_model_metadata(IEditorModelMetadataBuilder<UpdateJobTitleRequest> model_metadata_builder)
        {
        ...
        protected override void build_field_metadata(IEditorFieldsMetadataBuilder<UpdateJobTitleRequest> fields_metadata_builder)
        {
        ...
        protected override void build_action_metadata(IEditorActionsMetadataBuilder<UpdateJobTitleRequest> actions_metadata_builder)
        {
