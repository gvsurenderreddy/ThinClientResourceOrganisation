...
namespace WTS.WorkSuite.Web.ThinClient.Application.HR.ReferenceData.EthnicOrigins.Presentation.List
{
    public class MetadataConfiguration
                        : global::WorkSuite.Library.Asp.Net.Mvc.Server.Framework.ViewModels.DetailsLists.Metadata.Static.DetailsListMetadataBuilder< EthnicOriginDetails >
    {
        protected override void build_list_metadata( IDetailsListMetadataBuilder< EthnicOriginDetails > builder )
        {
            builder
        ...
        protected override void build_list_actions_metadata( IDetailsListActionsMetadataBuilder< EthnicOriginDetails > builder )
        {
            builder
                .add_action< DetailsList.New > ()
                .id( EthnicOrigins.Presentation.New.Resources.id )
                ;
        }
    }
}