...
{
    public class MetadataConfiguration : EditorMetadataBuilder<UpdateTitleRequest>
    {
        protected override void build_model_metadata(IEditorModelMetadataBuilder<UpdateTitleRequest> model_metadata_builder)
        {
        ...
        protected override void build_field_metadata(IEditorFieldsMetadataBuilder<UpdateTitleRequest> fields_metadata_builder)
        {
        ...
        protected override void build_action_metadata(IEditorActionsMetadataBuilder<UpdateTitleRequest> actions_metadata_builder)
        {
