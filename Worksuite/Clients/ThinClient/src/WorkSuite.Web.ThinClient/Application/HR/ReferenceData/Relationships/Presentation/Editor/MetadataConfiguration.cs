...
namespace WTS.WorkSuite.Web.ThinClient.Application.HR.ReferenceData.Relationships.Presentation.Editor
{
    public class MetadataConfiguration
                    : EditorMetadataBuilder<UpdateRelationshipRequest>
    {
        protected override void build_model_metadata
                                    (IEditorModelMetadataBuilder<UpdateRelationshipRequest> model_metadata_builder)
        {
        ...
        protected override void build_field_metadata
                                    (IEditorFieldsMetadataBuilder<UpdateRelationshipRequest> fields_metadata_builder)
        {
        ...
        protected override void build_action_metadata
                                    (IEditorActionsMetadataBuilder<UpdateRelationshipRequest> actions_metadata_builder)
        {
