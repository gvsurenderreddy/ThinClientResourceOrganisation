...
namespace WTS.WorkSuite.Web.ThinClient.Application.HR.ReferenceData.Locations.Presentation.Editor
{
    public class MetadataConfiguration
                    : EditorMetadataBuilder<UpdateLocationRequest>
    {
        protected override void build_model_metadata(IEditorModelMetadataBuilder<UpdateLocationRequest> model_metadata_builder)
        {
        ...
        protected override void build_field_metadata(IEditorFieldsMetadataBuilder<UpdateLocationRequest> fields_metadata_builder)
        {
        ...
        protected override void build_action_metadata(IEditorActionsMetadataBuilder<UpdateLocationRequest> actions_metadata_builder)
        {
