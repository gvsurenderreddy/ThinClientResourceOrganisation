...
namespace WTS.WorkSuite.Web.ThinClient.Application.HR.ReferenceData.Genders.Presentation.Editor
{
    public class MetadataConfiguration
                    : EditorMetadataBuilder<UpdateGenderRequest>
    {
        protected override void build_model_metadata
                                    (IEditorModelMetadataBuilder<UpdateGenderRequest> model_metadata_builder)
        {
        ...
        protected override void build_field_metadata
                                    (IEditorFieldsMetadataBuilder<UpdateGenderRequest> fields_metadata_builder)
        {
        ...
        protected override void build_action_metadata
                                    (IEditorActionsMetadataBuilder<UpdateGenderRequest> actions_metadata_builder)
        {
