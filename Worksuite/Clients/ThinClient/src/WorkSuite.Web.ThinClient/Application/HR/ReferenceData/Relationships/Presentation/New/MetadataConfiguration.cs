...
namespace WTS.WorkSuite.Web.ThinClient.Application.HR.ReferenceData.Relationships.Presentation.New
{
    public class MetadataConfiguration
                    : EditorMetadataBuilder<CreateRelationshipRequest>
    {
        protected override void build_model_metadata
                                    (IEditorModelMetadataBuilder<CreateRelationshipRequest> metadata_builder)
        {
            metadata_builder
        ...
        protected override void build_field_metadata
                                    (IEditorFieldsMetadataBuilder<CreateRelationshipRequest> metadata_builder)
        {
            metadata_builder
        ...
        protected override void build_action_metadata
                                    (IEditorActionsMetadataBuilder<CreateRelationshipRequest> metadata_builder)
        {
