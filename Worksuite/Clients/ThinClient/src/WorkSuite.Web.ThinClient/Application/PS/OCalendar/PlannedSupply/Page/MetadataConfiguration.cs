...
namespace WTS.WorkSuite.Web.ThinClient.Application.Operations.OperationalCalendars.PlannedSupply.View.Page
{
                        ...
                        : PageMetadataBuilder
    {
        ...
        protected override void build_worklow_metadata(IWorkflowMetadataBuilder builder)
        {
            builder
                .for_page(Resources.page_id)
                    .for_editor<RemoveOperationsCalendarRequest>()
                        .for_action<SubmitRemove>()
                            .add_destination(OperationalCalendars.View.Page.Resources.page_id, OperationalCalendars.View.Page.Resources.page_title)

                        .for_editor<RemoveShiftCalendarRequest>()
                            .for_action<SubmitRemove>()
                                .add_destination(Resources.page_id, Resources.page_title)
