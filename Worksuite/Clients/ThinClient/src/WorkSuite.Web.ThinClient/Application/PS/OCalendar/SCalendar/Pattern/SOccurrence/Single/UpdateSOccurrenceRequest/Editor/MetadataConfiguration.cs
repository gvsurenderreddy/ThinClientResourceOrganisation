...
using EditorActions = WorkSuite.Library.Asp.Net.Mvc.Server.Infrastructure.ActionDefinitions.Editor;
...
namespace WTS.WorkSuite.Web.ThinClient.Application.Operations.OperationalCalendars.PlannedSupply.ShiftCalendars.Patterns.ShiftOccurrences.Edit.Presentation.Editor
{
    public class MetadataConfiguration
                         : EditorMetadataBuilder<EditSingleShiftOccurrenceRequest>
    {
        protected override void build_model_metadata(IEditorModelMetadataBuilder<EditSingleShiftOccurrenceRequest> model_metadata_builder)
        {
        ...
        protected override void build_field_metadata(IEditorFieldsMetadataBuilder<EditSingleShiftOccurrenceRequest> fields_metadata_builder)
        {
        ...
        protected override void build_action_metadata(IEditorActionsMetadataBuilder<EditSingleShiftOccurrenceRequest> actions_metadata_builder)
        {
            actions_metadata_builder
                .add_action<EditorActions.Save>()
                .call_to_action<PrimaryCallToAction>()
                .id(Command.Update.Resources.id)
            ...
            actions_metadata_builder
                .add_action<EditorActions.Cancel>()
