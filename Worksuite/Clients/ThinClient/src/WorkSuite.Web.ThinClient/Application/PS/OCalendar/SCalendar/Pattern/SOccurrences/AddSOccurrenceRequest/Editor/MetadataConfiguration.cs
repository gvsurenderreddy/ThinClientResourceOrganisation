...
namespace WTS.WorkSuite.Web.ThinClient.Application.Operations.OperationalCalendars.PlannedSupply.ShiftCalendars.Patterns.ShiftOccurrences.New.Presentation.Editor
{
    public class MetadataConfiguration
                      : EditorMetadataBuilder<NewShiftOccurrenceRequest>
    {
        protected override void build_model_metadata(IEditorModelMetadataBuilder<NewShiftOccurrenceRequest> model_metadata_builder)
        {
        ...
        protected override void build_field_metadata(IEditorFieldsMetadataBuilder<NewShiftOccurrenceRequest> fields_metadata_builder)
        {
            ...
            fields_metadata_builder
                ...
                .colour_picker_palette(m => new ColourPickerPaletteBuilder()
                                                                    ...
                                                                    .build(NewShiftColourPaletteJson)
                );

            fields_metadata_builder
                .for_field(x => x.start_date)
                .id("start_date")
                .label("Date")
                .readonly_display_string(m => m.start_date.FormatForReport());
        ...
        protected override void build_action_metadata(IEditorActionsMetadataBuilder<NewShiftOccurrenceRequest> actions_metadata_builder)
        {
            actions_metadata_builder
                .add_action<SubmitNew>()
                .call_to_action<PrimaryCallToAction>()
                .id(Commands.New.Resources.id)
                .route_parameter_factory(m => new { m.operations_calendar_id, m.shift_calendar_id, m.shift_calendar_pattern_id, start_date = m.start_date.ToClientSideUrlSafeInvariantCultureString() });
        ...
        private const string NewShiftColourPaletteJson = "{ " +
