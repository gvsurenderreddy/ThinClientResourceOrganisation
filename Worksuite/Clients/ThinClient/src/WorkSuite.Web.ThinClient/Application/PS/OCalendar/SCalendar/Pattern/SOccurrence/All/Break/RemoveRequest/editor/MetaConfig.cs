...
{
    public class MetadataConfiguration : EditorMetadataBuilder<RemoveShiftBreakForAllOccurrencesRequest>
    {
        protected override void build_model_metadata(IEditorModelMetadataBuilder<RemoveShiftBreakForAllOccurrencesRequest> builder)
        {
            builder
        ...
        protected override void build_field_metadata(IEditorFieldsMetadataBuilder<RemoveShiftBreakForAllOccurrencesRequest> builder)
        {
            builder
        ...
        protected override void build_action_metadata(IEditorActionsMetadataBuilder<RemoveShiftBreakForAllOccurrencesRequest> builder)
        {
            builder
                .add_action<Save>()
                .title("Remove")
