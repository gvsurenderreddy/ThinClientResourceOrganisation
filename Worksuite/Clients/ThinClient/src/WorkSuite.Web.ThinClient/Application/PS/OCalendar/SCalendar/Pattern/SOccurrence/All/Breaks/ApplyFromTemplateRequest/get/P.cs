...
{
    public class ApplyShiftBreaksFromBreakTemplateForAllOccurrencesEditorPresenter : Presenter
    {
        public ActionResult Editor(ShiftOccurrenceIdentity shift_occurrence_identity)
        {
            ...
            var view_model = editor_builder
                                    ...
                                    .build(update_request.ToApplyShiftBreaksFromBreakTemplateForAllOccurrencesRequest())
                                    ;

            return View(@"~\Views\Shared\Views\Editor.cshtml", view_model);
        }

        public ApplyShiftBreaksFromBreakTemplateForAllOccurrencesEditorPresenter(IGetApplyShiftBreaksFromBreakTemplateRequest the_get_update_request
                                                                , IGetAllBreakTemplatesDetails the_get_all_break_templates
                                                                , EditorBuilder<ApplyShiftBreaksFromBreakTemplateForAllOccurrencesRequest> the_editor_builder)
        {
        ...
        private readonly EditorBuilder<ApplyShiftBreaksFromBreakTemplateForAllOccurrencesRequest> editor_builder;
