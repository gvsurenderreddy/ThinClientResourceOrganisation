...
namespace WTS.WorkSuite.Web.ThinClient.Application.Operations.OperationalCalendars.PlannedSupply.ShiftCalendars.Patterns.ShiftOccurrences.ShiftBreaksForAll.Types
{
    ...
    public class EditShiftBreakForAllOccurrencesRequest : EditShiftBreakRequest
    {

    }


    public static class EditShiftBreakRequestExtensions
    {
        public static EditShiftBreakForAllOccurrencesRequest ToEditShiftBreakForAllOccurrencesRequest(
                                                                                                this EditShiftBreakRequest source)
        {
            var mapper = new EditShiftBreakRequestForAllOccurrencesMapper();
            return mapper.Map(source);
        }
    }

    public class EditShiftBreakRequestForAllOccurrencesMapper
    {
        public Func<EditShiftBreakRequest, EditShiftBreakForAllOccurrencesRequest> Map
        {
            get
            {
                return details => new EditShiftBreakForAllOccurrencesRequest()
                {
