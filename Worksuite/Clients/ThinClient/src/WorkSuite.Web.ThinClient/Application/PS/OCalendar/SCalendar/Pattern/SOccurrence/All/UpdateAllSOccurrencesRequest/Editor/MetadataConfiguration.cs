...
namespace WTS.WorkSuite.Web.ThinClient.Application.Operations.OperationalCalendars.PlannedSupply.ShiftCalendars.Patterns.ShiftOccurrences.EditAll.Presentation.Editor
{
    public class MetadataConfiguration
                    : EditorMetadataBuilder<EditAllShiftOccurrencesRequest>
    {
        protected override void build_model_metadata(IEditorModelMetadataBuilder<EditAllShiftOccurrencesRequest> model_metadata_builder)
        {
        ...
        protected override void build_field_metadata(IEditorFieldsMetadataBuilder<EditAllShiftOccurrencesRequest> fields_metadata_builder)
        {
        ...
        protected override void build_action_metadata(IEditorActionsMetadataBuilder<EditAllShiftOccurrencesRequest> actions_metadata_builder)
        {
            actions_metadata_builder
                .add_action<EditorActions.Save>()
                .call_to_action<PrimaryCallToAction>()
                .title("Save all")
                .id(Command.UpdateAll.Resources.id)
