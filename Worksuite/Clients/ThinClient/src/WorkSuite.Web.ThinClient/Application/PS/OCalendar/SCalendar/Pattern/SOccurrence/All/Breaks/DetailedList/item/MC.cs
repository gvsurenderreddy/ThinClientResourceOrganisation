...
namespace WTS.WorkSuite.Web.ThinClient.Application.Operations.OperationalCalendars.PlannedSupply.ShiftCalendars.Patterns.ShiftOccurrences.ShiftBreaksForAll.Presentation.Report
{
    public class MetadataConfiguration : ReportMetadataBuilder<ShiftBreakDetailsForAllOccurrences>
    {
        protected override void build_model_metadata(IReportModelMetadataBuilder<ShiftBreakDetailsForAllOccurrences> model_metadata_builder)
        {
        ...
        protected override void build_field_metadata(IReportFieldsMetadataBuilder<ShiftBreakDetailsForAllOccurrences> fields_metadata_builder)
        {
        ...
        protected override void build_action_metadata(IReportActionsMetadataBuilder<ShiftBreakDetailsForAllOccurrences> actions_metadata_builder)
        {
