...
namespace WTS.WorkSuite.Web.ThinClient.Application.Operations.OperationalCalendars.PlannedSupply.ShiftCalendars.Patterns.ShiftOccurrences.ShiftBreaksForAll.Commands.Edit
{
    ...
    /// </summary>
    public class EditShiftBreakForAllOccurrencesController : Controller
    {
        ...
        public EditShiftBreakForAllOccurrencesController(IEditShiftBreakForAllOccurrences the_command)
        {
            command = Guard.IsNotNull(the_command, "the_command");
        }

        private readonly IEditShiftBreakForAllOccurrences command;
    }
}