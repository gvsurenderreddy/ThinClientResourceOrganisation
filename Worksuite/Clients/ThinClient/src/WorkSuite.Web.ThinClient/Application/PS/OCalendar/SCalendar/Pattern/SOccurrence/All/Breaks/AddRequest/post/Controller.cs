...
namespace WTS.WorkSuite.Web.ThinClient.Application.Operations.OperationalCalendars.PlannedSupply.ShiftCalendars.Patterns.ShiftOccurrences.ShiftBreaksForAll.Commands.New
{
    ...
    /// </summary>
    public class NewShiftBreakForAllOccurrencesController : Controller
    {
        ...
        public NewShiftBreakForAllOccurrencesController(INewShiftBreakForAllOccurrences the_command)
        {
            command = Guard.IsNotNull(the_command, "the_command");
        }

        private readonly INewShiftBreakForAllOccurrences command;
    }
}