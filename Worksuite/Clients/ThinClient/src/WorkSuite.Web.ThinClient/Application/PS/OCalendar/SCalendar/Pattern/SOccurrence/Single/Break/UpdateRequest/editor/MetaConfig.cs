...
{
    public class MetadataConfiguration : EditorMetadataBuilder<EditShiftBreakRequest>
    {
        protected override void build_model_metadata(IEditorModelMetadataBuilder<EditShiftBreakRequest> builder)
        {
            builder
        ...
        protected override void build_field_metadata(IEditorFieldsMetadataBuilder<EditShiftBreakRequest> builder)
        {
            builder
        ...
        protected override void build_action_metadata(IEditorActionsMetadataBuilder<EditShiftBreakRequest> builder)
        {
            builder
                .add_action<Save>()
