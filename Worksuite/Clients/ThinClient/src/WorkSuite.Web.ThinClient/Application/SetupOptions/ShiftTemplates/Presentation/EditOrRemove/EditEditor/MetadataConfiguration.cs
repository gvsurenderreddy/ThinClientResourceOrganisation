...
namespace WTS.WorkSuite.Web.ThinClient.Application.SetupOptions.ShiftTemplates.Presentation.EditOrRemove.EditEditor
{
    public class MetadataConfiguration
                      : EditorMetadataBuilder<UpdateShiftTemplateRequest>
    {
        protected override void build_model_metadata
                                       (IEditorModelMetadataBuilder<UpdateShiftTemplateRequest> model_metadata_builder)
        {
        ...
        protected override void build_field_metadata
                                       (IEditorFieldsMetadataBuilder<UpdateShiftTemplateRequest> fields_metadata_builder)
        {
            ...
            fields_metadata_builder
                ...
                .colour_picker_palette(m => new ColourPickerPaletteBuilder()
                                                                        ...
                                                                        .build(EditShiftTemplateColourPaletteJson)
                                        );
        ...
        protected override void build_action_metadata
                                    (IEditorActionsMetadataBuilder<UpdateShiftTemplateRequest> actions_metadata_builder)
        {
            actions_metadata_builder
                .add_action<SubmitEdit>()
                .call_to_action<PrimaryCallToAction>()
                .id(Commands.Update.Command.Update.Resource.id)
        ...
        private const string EditShiftTemplateColourPaletteJson = "{ " +
