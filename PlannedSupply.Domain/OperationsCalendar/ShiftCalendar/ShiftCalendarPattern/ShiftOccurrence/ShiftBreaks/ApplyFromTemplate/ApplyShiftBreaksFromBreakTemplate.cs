...
{
    public class ApplyShiftBreaksFromBreakTemplate : IApplyShiftBreaksFromBreakTemplate
    {
        ...
        private ApplyShiftBreaksFromBreakTemplate set_request(ApplyShiftBreaksFromBreakTemplateRequest the_request)
        {
        ...
        private ApplyShiftBreaksFromBreakTemplate get_the_shift_occurrence()
        {
        ...
        private ApplyShiftBreaksFromBreakTemplate get_the_breaks_from_break_template()
        {
            if (response_builder.has_errors) return this;
        ...
        private ApplyShiftBreaksFromBreakTemplate validate_break_template_request()
        {
            if (response_builder.has_errors) return this;
        ...
        private ApplyShiftBreaksFromBreakTemplate build_find_or_create_request()
        {
            if (response_builder.has_errors) return this;
        ...
        private ApplyShiftBreaksFromBreakTemplate find_or_create_time_allocation()
        {
            if (response_builder.has_errors) return this;
        ...
        private ApplyShiftBreaksFromBreakTemplate change_time_allocation()
        {
            if (response_builder.has_errors) return this;
        ...
        private ApplyShiftBreaksFromBreakTemplate commit()
        {
            if (response_builder.has_errors) return this;
        ...
        public ApplyShiftBreaksFromBreakTemplate(IUnitOfWork the_unit_of_work,
