...
{
    public class NewShiftBreakForAllOccurrences : INewShiftBreakForAllOccurrences
    {
        ...
        private NewShiftBreakForAllOccurrences set_request(NewShiftBreakRequest the_request)
        {
        ...
        private NewShiftBreakForAllOccurrences get_the_shift_occurrence()
        {
        ...
        private NewShiftBreakForAllOccurrences build_combined_find_or_create_request()
        {
            if (response_builder.has_errors) return this;
        ...
        private NewShiftBreakForAllOccurrences find_or_create_time_allocation()
        {
            if (response_builder.has_errors) return this;
        ...
        private NewShiftBreakForAllOccurrences find_all_occurrences_of_same_type_and_change_their_time_allocation()
        {
            if (response_builder.has_errors) return this;
        ...
        private NewShiftBreakForAllOccurrences commit()
        {
            if (response_builder.has_errors) return this;
        ...
        public NewShiftBreakForAllOccurrences(IUnitOfWork the_unit_of_work,
