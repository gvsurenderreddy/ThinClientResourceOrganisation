...
{
    public class RemoveShiftBreakForAllOccurrences : IRemoveShiftBreakForAllOccurrences
    {
        ...
        private RemoveShiftBreakForAllOccurrences set_request(RemoveShiftBreakRequest the_request)
        {
        ...
        private RemoveShiftBreakForAllOccurrences get_the_shift_occurrence()
        {
        ...
        private RemoveShiftBreakForAllOccurrences get_the_break_to_be_removed()
        {
            if (response_builder.has_errors) return this;
        ...
        private RemoveShiftBreakForAllOccurrences build_find_or_create_request()
        {
            if (response_builder.has_errors) return this;
        ...
        private RemoveShiftBreakForAllOccurrences find_or_create_time_allocation()
        {
            if (response_builder.has_errors) return this;
        ...
        private RemoveShiftBreakForAllOccurrences find_all_occurrences_of_same_type_and_change_their_time_allocation()
        {
            if (response_builder.has_errors) return this;
        ...
        private RemoveShiftBreakForAllOccurrences commit()
        {
            if (response_builder.has_errors) return this;
        ...
        public RemoveShiftBreakForAllOccurrences(IUnitOfWork the_unit_of_work,
