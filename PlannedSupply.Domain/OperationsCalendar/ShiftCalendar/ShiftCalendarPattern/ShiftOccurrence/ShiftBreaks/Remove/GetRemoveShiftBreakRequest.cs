...
{
    public class GetRemoveShiftBreakRequest : IGetRemoveShiftBreakRequest
    {
        public Response<RemoveShiftBreakRequest> execute(ShiftBreakIdentity request)
        {
            ...
            return new Response<RemoveShiftBreakRequest>()
            {
                result = new RemoveShiftBreakRequest()
                {
                    ...
                    duration = shift_break.duration_in_seconds.to_duration_request().to_domain_format_string(),
                    off_set = shift_break.offset_from_start_time_in_seconds.to_duration_request().to_domain_format_string(),
        ...
        public GetRemoveShiftBreakRequest(GetOccurrence the_get_occurrence)
        {
