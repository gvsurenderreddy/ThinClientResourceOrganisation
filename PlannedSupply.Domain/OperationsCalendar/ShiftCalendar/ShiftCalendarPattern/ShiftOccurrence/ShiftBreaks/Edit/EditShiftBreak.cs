...
{
    public class EditShiftBreak : IEditShiftBreak
    {
        ...
        private EditShiftBreak set_request(EditShiftBreakRequest the_request)
        {
        ...
        private EditShiftBreak get_the_shift_occurrence()
        {
        ...
        private EditShiftBreak get_the_break_to_be_edited()
        {
            if (response_builder.has_errors) return this;
        ...
        private EditShiftBreak build_find_or_create_request()
        {
            if (response_builder.has_errors) return this;
        ...
        private EditShiftBreak find_or_create_time_allocation()
        {
            if (response_builder.has_errors) return this;
        ...
        private EditShiftBreak change_occurrence_time_allocation()
        {
            if (response_builder.has_errors) return this;
        ...
        public EditShiftBreak(IUnitOfWork the_unit_of_work,
