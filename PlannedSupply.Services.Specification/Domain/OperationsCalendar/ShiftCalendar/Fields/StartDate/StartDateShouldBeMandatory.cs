...
namespace WTS.WorkSuite.PlannedSupply.Services.Domain.OperationsCalendar.ShiftCalendar.Fields.StartDate
{
    ...
    [TestClass]
    public class StartDateShouldBeMandatory : MandatoryDateFieldSpecification < PublishShiftCalendarRequest
                                                                              , PublishShiftCalendarResponse
                                                                              , PublishDatesShiftCalendarFixture>
    {
        public StartDateShouldBeMandatory()
    ...
    [TestClass]
    public class CheckErrorMessageForStartDateShouldBeMandatory : PlannedSupplySpecification
    {
        [TestMethod]
        public void report_error_message_when_start_date_is_null()
        {
            fixture.request.start_date = new DateRequest { year = null, month = null, day = null};
        ...
        [TestMethod]
        public void show_red_border_around_fields_when_start_date_is_null()
        {
            fixture.request.start_date = new DateRequest { year = null, month = null, day = null };
            fixture.execute_command();
            var response = fixture.response;
