...
namespace WTS.WorkSuite.PlannedSupply.Services.Domain.OperationsCalendar.ShiftCalendar.Fields.EndDate
{
    ...
    {
        [TestMethod]
        public void report_error_message_when_end_date_failed_sanitisation()
        {
            fixture.request .end_date =new DateRequest{ year = "2015", month = "04", day ="31" };
        ...
        [TestMethod]
        public void show_red_border_around_fields_when_end_date_failed_sanitisation()
        {
            fixture.request.end_date = new DateRequest { year = "2015", month = "04", day = "31" };
            fixture.execute_command();
            var response = fixture.response;
