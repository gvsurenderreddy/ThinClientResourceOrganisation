...
{
    public class Remove_shift_calendar_pattern_will_publish_auto_reordered_events
    {
        [TestClass]
        public class WhenAShiftCalendarPatternIsRemoved
                        : ReorderShiftCalendarPatternSpecifiction
        {
            ...
            {
                // Act
                var shift_calendar_pattern_identity = new ShiftCalendarPatternIdentity
                {
                ...
                fixture.execute_command(shift_calendar_pattern_identity);

                fixture
                    .get_last_shift_calendar_pattern_auto_reordered_event_for(shift_calendar_pattern_identity)
                    .Match(
