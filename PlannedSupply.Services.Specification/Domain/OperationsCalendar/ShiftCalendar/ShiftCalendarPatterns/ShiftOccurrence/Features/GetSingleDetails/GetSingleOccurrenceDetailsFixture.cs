...
{
    public class GetSingleOccurrenceDetailsFixture
    {
        ...
        public Response<SingleOccurrenceDetails> response { get; private set; }
        ...
        public GetSingleOccurrenceDetailsFixture(IGetSingleOccurrenceDetails the_query, 
        ...
        private readonly IGetSingleOccurrenceDetails query;
