...
{
    public class ApplyShiftBreaksFromBreakTemplateFixture : ResponseCommandVerifiedByAnEntitiesStateFixture<ApplyShiftBreaksFromBreakTemplateRequest,
                                                                                                                ApplyShiftBreaksFromBreakTemplateResponse,
                                                                                                                IApplyShiftBreaksFromBreakTemplate,
                                                                                                                TimeAllocationOccurrence>
    {
        ...
        public ApplyShiftBreaksFromBreakTemplateFixture(IApplyShiftBreaksFromBreakTemplate the_new_shift_calendar_pattern
                                                            , IRequestHelper<ApplyShiftBreaksFromBreakTemplateRequest> the_new_shift_calendar_pattern_request
