...
{
    public class RemoveShiftBreakFixture : ResponseCommandFixture<RemoveShiftBreakRequest, RemoveShiftBreakResponse, IRemoveShiftBreak>
    {
        ...
        public RemoveShiftBreakFixture(IRemoveShiftBreak the_command, 
