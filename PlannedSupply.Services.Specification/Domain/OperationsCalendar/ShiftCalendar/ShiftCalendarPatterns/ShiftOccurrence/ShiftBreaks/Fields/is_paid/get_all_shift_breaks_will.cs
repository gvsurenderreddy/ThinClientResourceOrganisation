...
namespace WTS.WorkSuite.PlannedSupply.Services.Domain.OperationsCalendar.ShiftCalendar.ShiftCalendarPatterns.ShiftOccurrence.ShiftBreaks.Fields.is_paid
{
    [TestClass]
    public class get_all_shift_breaks_will : GetAllShiftBreaksSpecification
    {
        [TestMethod]
        public void correctly_map_the_is_paid_field()
        {
            ...
            Assert.AreEqual(expected_break.is_paid, response.is_paid);
        }
    }
}
