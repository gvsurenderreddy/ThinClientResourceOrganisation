...
{
    public class TemplateName_should_be_restricted_to_the_maximum_number_of_characters
    {
        [TestClass]
        public class On_create
                        : TextFieldDoesNotExceedDefaultMaximumNumberOfCharactersSpecification<NewBreakTemplateRequest,
        ...
        public class On_update
                        : TextFieldDoesNotExceedDefaultMaximumNumberOfCharactersSpecification<UpdateBreakTemplateRequest,
