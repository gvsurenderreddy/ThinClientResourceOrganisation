...
{
    public class Duration_should_be_valid_when_the_value_is_between_one_minute_and_twenty_four_hours
    {
        [TestClass]
                        ...
                        : PlannedSupplySpecification
        {
            ...
            public void given_one_minute_more_than_twenty_four_hours_should_report_errors()
            {
                ...
                response.messages.Should().Contain(m => m.field_name == "duration" && m.message == ValidationMessages.error_00_0071);
