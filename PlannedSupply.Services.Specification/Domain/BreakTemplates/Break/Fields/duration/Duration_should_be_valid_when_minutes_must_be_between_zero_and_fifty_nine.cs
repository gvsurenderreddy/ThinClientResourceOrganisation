...
{
    public class Duration_should_be_valid_when_minutes_must_be_between_zero_and_fifty_nine
    {
        [TestClass]
        ...
        {
            [TestMethod]
            public void minutes_in_the_text_format_should_report_error()
            {
                confirm_minutes_is_not_in_acceptable_as_it_is_not_a_number("test");
            }

            [TestMethod]
            public void minutes_less_than_zero_should_report_error()
            {
                confirm_minutes_is_not_in_acceptable_as_it_is_not_a_number("-1");
            }

            [TestMethod]
            public void minutes_greater_than_59_should_report_error()
            {
                confirm_minutes_is_not_in_acceptable_as_it_is_not_a_number("60");
            }

            private void confirm_minutes_is_not_in_acceptable_as_it_is_not_a_number(string the_value)
            {
