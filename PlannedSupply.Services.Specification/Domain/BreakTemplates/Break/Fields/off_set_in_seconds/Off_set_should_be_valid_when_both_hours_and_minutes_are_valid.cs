...
using ValidationMessages = Content.Services.PlannedSupply.Messages.ValidationMessages;

namespace WTS.WorkSuite.PlannedSupply.Services.Domain.BreakTemplates.Break.Fields.off_set_in_seconds
{
    public class Off_set_should_be_valid_when_both_hours_and_minutes_are_valid
    {
        [TestClass]
