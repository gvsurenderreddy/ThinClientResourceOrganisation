...
namespace WTS.WorkSuite.Library.DomainTypes.Tests.PostalAddresses.Validation.Fields.line_two {

    [TestClass]
    public class line_one_does_not_exceed_maximum_number_of_characters 
        ...
        public void reports_an_error_when_max_number_of_charaters_is_exceeded ( ) {            
            ...
            this
                ...
                .then(  )
                .line_two_exceeds_it_maximum_size_error_is_reported()
                ;
        }
