...
{
    public class DurationBetweenOneMinutesAandTwentyFourWill
    {
        public class Must_be_fully_specified
        {
            [TestClass]
            ...
            [TestClass]
            public class minutes_must_be_specified
            {
            ...
            [TestClass]
            public class hour_and_mniute_should_be_valid
            {
                [TestMethod]
        ...
        public class componant_must_be_valid
        {
            [TestClass]
        ...
        public class duration_must_be_between_one_minute_and_twenty_four_hours
        {
            [TestClass]
            public class time_intwenty_four_hour
            {
        ...
        [TestClass]
        public class valid_duration_requests_return_the_time_in_seconds
        {
        ...
        {
            public DurationIsBetweenOneMinuteAndTwentyFourHours duration_validator { get; private set; }
            ...
            {
                duration_validator = new DurationIsBetweenOneMinuteAndTwentyFourHours();
            }
        }
    }
}