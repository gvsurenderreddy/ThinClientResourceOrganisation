...
namespace WorkSuite.Library.Asp.Net.Mvc.Server.Tests.Framework.ViewModels.Tiles.DynamicTiles.StaticallyDefined.Fields.Fields.Classes {
    ...
    public class Classes_can_be_defined_statically {
        ...
        public void can_add_as_a_string() {
            ...
            tile.fields.First( f => f.name == "a_property" ).classes.Should().Contain("a class");
        }
        ...
        public void can_add_as_an_expression() {
            ...
            tile.fields.First(f => f.name == "a_property").classes.Should().Contain(a_class);
        }
        ...
        public void is_an_empty_collection_if_none_specified() {
            ...
            tile.fields.First(f => f.name == "a_property").classes.Should().NotBeNull();
            tile.fields.First(f => f.name == "a_property").classes.Should().BeEmpty();
        }
