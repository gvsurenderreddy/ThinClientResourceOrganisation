...
namespace WorkSuite.Library.Asp.Net.Mvc.Server.Tests.DateRangeBars.StaticallyDefined.Features {

    [TestClass]
    public class date_range_bar_will {

        // done: from the a property of the model

        [TestMethod]
        public void build_a_7_day_range_string() 
        {

            model.a_start_date_time = new DateTime(2014, 1, 1);// 1st of Jan 2014
            model.a_range = ShiftCalendarRange.Week;

            definition_builder
                .start_date(m => m.a_start_date_time)
                .date_range(m=>m.a_range)
                ;
        ...
        [TestMethod]
        public void build_a_28_day_range_string()
        {

            model.a_start_date_time = new DateTime(2014, 1, 1);// 1st of Jan 2014
            model.a_range = ShiftCalendarRange.FourWeek;
            ...
            date_range_bar.date_range_string.Should().Be("1 - 28 January 2014");
        }
