...
namespace WTS.WorkSuite.Library.DomainTypes.Duration.Validators.IsBetweenZeroMinuteAndTwentyFourHours
{
    public class DurationIsBetweenZeroMinuteAndTwentyFourHours
    {
                                        ...
                                        (DurationRequest durationRequest)
        {
            return this
                ...
                .validate_duration_is_within_zero_and_twenty_four_hour_period()
                ;
        }

        private DurationIsBetweenZeroMinuteAndTwentyFourHours set_request
        ...
        private DurationIsBetweenZeroMinuteAndTwentyFourHours sanatise_request()
        {
        ...
        private DurationIsBetweenZeroMinuteAndTwentyFourHours validate_has_been_fully_specified()
        {
            if (result.has_been_decided()) return this;
        ...
        private DurationIsBetweenZeroMinuteAndTwentyFourHours validate_components()
        {
            if (result.has_been_decided()) return this;
            Guard.IsNotNull(duration_request, "duration_request");
        ...
        private DurationIsBetweenZeroMinuteAndTwentyFourHours calculate_duration_in_second()
        {
            if (result.has_been_decided()) return this;
        ...
        private DurationValidationResult validate_duration_is_within_zero_and_twenty_four_hour_period()
        {
            ...
            duration_in_seconds
                   .Value
                   .check_duration_is_between_zero_and_twenty_four_hour(
                          is_valid:
                          duration_in_second_from_midnight => duration_in_seconds = duration_in_second_from_midnight,
