...
namespace WorkSuite.Library.Asp.Net.Mvc.Server.SimplePalettes.Dynamic.StaticDefinitions.Definitions.Actions {
    ...
    /// <summary>
    ///     Allows you to add content action defintions to a simple palette defintion
    /// </summary>
    /// <typeparam name="S">
    ///     The type of the simple palette model 
    /// </typeparam>
    public class DynamicSimplePaletteActionStaticDefinitionBuilder<S> {
        ...
        /// </returns>
        public DynamicSimplePaletteActionStaticDefinitionBuilder<S> title
                                                                        ( string value ) {
        ...
        ///     The builder so that this method can be used as part of a fluent interface.
        /// </returns>
        internal DynamicSimplePaletteActionStaticDefinitionBuilder<S> name
                                                                        ( string value ) {
        ...
        ///     The builder so that this method can be used as part of a fluent interface.
        /// </returns>
        public DynamicSimplePaletteActionStaticDefinitionBuilder<S> component_context
                                                                        (string value)
        {

            defintion.component_context = m => value;
            return this;
        }
        ...
        ///     The builder so that this method can be used as part of a fluent interface.
        /// </returns>
        public DynamicSimplePaletteActionStaticDefinitionBuilder<S> add_class
                                                                        ( string value ) {
        ...
        ///     The builder so that this method can be used as part of a fluent interface.
        /// </returns>
        public DynamicSimplePaletteActionStaticDefinitionBuilder<S> url
                                                                        ( string value ) {
        ...
        ///     The builder so that this method can be used as part of a fluent interface.
        /// </returns>
        public DynamicSimplePaletteActionStaticDefinitionBuilder<S> url_from_route
                                                                        ( string route_name
        ...
        /// <summary>
        ///     Add the action defintion to simple palette definition
        /// </summary>
        public void add() {
        ...
        public DynamicSimplePaletteActionStaticDefinitionBuilder 
                ( Action<DynamicSimplePaletteActionStaticDefintion<S>> add_definition_delegate ) {

            add_definition = Guard.IsNotNull( add_definition_delegate, "add_definition_delegate" );
            
            defintion = new DynamicSimplePaletteActionStaticDefintion<S> {
        ...
        private readonly Action<DynamicSimplePaletteActionStaticDefintion<S>> add_definition;
        private readonly DynamicSimplePaletteActionStaticDefintion<S> defintion;
    }
}