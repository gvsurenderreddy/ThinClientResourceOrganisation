...
{
    /// <summary>
    ///     Adds action definition for the Shift Calendar Actions builder.
    /// </summary>
    /// <typeparam name="T">
    ...
    ///     Shift Calendar.
    /// </returns>
    public class DynamicShiftCalendarActionsStaticDefinitionBuilder<S>
    {
        public DynamicShiftCalendarActionStaticDefinitionBuilder<S> new_action<T>()
                                    where T : CommonActionDefinition, new()
        {
            var action_definition_template = new T();
            var action_definition_builder = new DynamicShiftCalendarActionStaticDefinitionBuilder<S>(
        ...
        public DynamicShiftCalendarActionsStaticDefinitionBuilder(DynamicShiftCalendarStaticDefinitionRepository<S> the_repository)
        {
