...
{
    public class AnImageFieldBuilder<S> : Builder<S, AnImageField, string>
    {
        public AnImageFieldBuilder(IModelMetadata<S> the_model_metadata
        ...
        protected override void initialise_instance(AnImageField instance, PropertyInfo property, S source)
        {
