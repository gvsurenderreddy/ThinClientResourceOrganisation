...
namespace WorkSuite.Library.Asp.Net.Mvc.Server.Framework.ViewModels.Primitives.Fields.StringField {
    ...
    public class AStringReportFieldBuilder<S> : Builder<S,AStringReportField,string> {

        public AStringReportFieldBuilder 
        ...
        protected override void initialise_instance 
                                    ( AStringReportField field
                                    , PropertyInfo property
                                    , S source ) {
            
            base.initialise_instance( field, property, source );

            field.humanize = field_metadata.humanize;
        }
    }
